  ...
  theme.templates.spicetify = {
    ...
    text = ''
      :root, body, .Root {
        ...
        --spice-main-elevated: {{colors.surface_container_lowest.default.hex}} !important;
        --spice-main-transition: {{colors.surface_container_lowest.default.hex}} !important;
        --spice-highlight: {{colors.surface_container_low.default.hex}} !important;
        --spice-highlight-elevated: {{colors.surface_container_high.default.hex}} !important;
        --spice-sidebar: {{colors.surface_container_lowest.default.hex}} !important;
        --spice-player: {{colors.surface_container_lowest.default.hex}} !important;
        --spice-card: {{colors.surface_container_low.default.hex}} !important;
        --spice-shadow: {{colors.surface_container_lowest.default.hex}} !important;
