  ...
  theme.templates.spicetify = {
    ...
    text = ''
      :root, body, .Root {
        ...
        --spice-main-elevated: {{colors.surface.default.hex}} !important;
        ...
        --spice-sidebar: {{colors.surface.default.hex}} !important;
        --spice-player: {{colors.surface.default.hex}} !important;
        --spice-card: {{colors.surface.default.hex}} !important;
        --spice-shadow: {{colors.surface.default.hex}} !important;
